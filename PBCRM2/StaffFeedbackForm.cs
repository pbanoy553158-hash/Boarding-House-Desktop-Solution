...
namespace PBCRM2
{
    public class StaffFeedbackForm : Form
    {
        ...
        private void BuildInterface()
        {
            ...
            sendCard.Paint += (_, e) =>
            {
                ...
                e.Graphics.DrawRectangle(
                    ...
                    0,
                    0,
                    sendCard.ClientSize.Width - 1,
                    sendCard.ClientSize.Height - 1);
            };
            ...
            selectedTenantPanel.Paint += (_, e) =>
            {
                ...
                e.Graphics.DrawRectangle(
                    ...
                    0,
                    0,
                    selectedTenantPanel.ClientSize.Width - 1,
                    selectedTenantPanel.ClientSize.Height - 1);
            };
        ...
        private async Task LoadFeedbackAsync()
        {
            try
            {
                ...
                var feedback =
                    await _apiService
                        .GetAsync<List<StaffFeedbackDto>>(
                            "api/Feedback");
                ...
                lblCount.Text =
                    orderedFeedback.Count == 1
                        ? "1 feedback"
                        : $"{orderedFeedback.Count} feedback";
        ...
        private async Task SendFeedbackRequestAsync()
        {
            ...
            try
            {
                ...
                var result =
                    await _apiService
                        .PostAsync<StaffFeedbackRequestResponse>(
        ...
        private void ShowSelectedFeedback()
        {
            ...
            if (row.DataBoundItem
                is not StaffFeedbackDto feedback)
            {
                return;
            }
        ...
        private class StaffFeedbackDto
        {
        ...
        // =========================================================
        // STAFF FEEDBACK REQUEST RESPONSE
        // =========================================================

        private class StaffFeedbackRequestResponse
        {
